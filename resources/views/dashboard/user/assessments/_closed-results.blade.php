<span id="closed-assessments-total-value" class="d-none">{{ $closedAssessments->total() }}</span>
    ...
    <div class="table-responsive assessments-view-table">
        <table class="table table-hover align-middle mb-0">
            <thead class="table-light">
                <tr>
                    <x-sortable-th field="title" label="Title" sort-param="closed_sort" dir-param="closed_dir" page-param="closed_page" />
                    <th>Team</th>
