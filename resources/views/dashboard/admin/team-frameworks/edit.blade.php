...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('admin.team-frameworks.update', $framework->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <button type="submit" class="btn btn-primary">Update Framework</button>
        </form>
    </div>
@endsection
